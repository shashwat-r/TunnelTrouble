...
//Useful function declarations. These functions will be defined in later codes.
...
// Useful check and modify functions
...
// Reset function that runs each time we collide
void resetAll() {
    division = 0.0;
    sceneRotate = 0.0;
    tunnelAngle = 0.0;
...
// handler functions for mouse keyboard and resize
